"""Interactive demo showing metamorphic relations visually."""
...
def plot_images_side_by_side(
    ...
    fig.patch.set_facecolor(color if not passed else "white")
...
def demo_mr1_identity():
    ...
    print(f"\nSource image predicted as: {source_pred} (conf: {source_logits.max():.2f})")
    print(f"Follow-up (same) image predicted as: {follow_up_pred} (conf: {follow_up_logits.max():.2f})")
    ...
    plot_images_side_by_side(
        ...
        source_logits,
        follow_up_logits,
        "MR1: Identity - Expected: predictions match",
        passed,
    )
...
def demo_mr2_double_flip():
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"Double-flipped image predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'}")
    ...
    plot_images_side_by_side(
        ...
        follow_up[0],
        "Original",
        "After 2× horizontal flip",
        source_pred,
        follow_up_pred,
        source_logits,
        follow_up_logits,
        "MR2: Double Flip - Expected: predictions match",
        passed,
    )
...
def demo_mr3_rotate_inverse():
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"Rotate +12° then -12° predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'}")
    ...
    plot_images_side_by_side(
        ...
        source_logits,
        follow_up_logits,
        "MR3: Rotate Inverse - Expected: predictions match",
        passed,
    )
...
def demo_mr4_brightness():
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"15% brighter image predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'}")
    ...
    plot_images_side_by_side(
        ...
        source_logits,
        follow_up_logits,
        "MR4: Brightness - Expected: same prediction",
        passed,
    )
...
def demo_mr5_blur():
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"Blurred image predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'}")
    ...
    plot_images_side_by_side(
        ...
        source_logits,
        follow_up_logits,
        "MR5: Blur - Expected: same prediction",
        passed,
    )


def demo_extreme_rotation_failure():
    """Intentional failure case: rotation too large to be reversible."""
    print("\n" + "=" * 70)
    print("CHALLENGE CASE: Extreme Rotation (45°) - Should FAIL")
    print("=" * 70)
    print("(This demonstrates how large transformations can break MRs)")
    ...
    source = images[idx : idx + 1]
    # Rotate extreme: 45° is too large for MNIST digit recognition
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"Extreme rotate ±45° predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'} (Expected to fail)")
    ...
    plot_images_side_by_side(
        ...
        source_logits,
        follow_up_logits,
        "Challenge: Extreme Rotation - EXPECTED FAILURE",
        passed,
    )


def demo_aggressive_blur_failure():
    """Intentional failure case: blur too aggressive."""
    print("\n" + "=" * 70)
    print("CHALLENGE CASE: Aggressive Blur - More likely to FAIL")
    print("=" * 70)
    print("(This shows the boundary of what the model can handle)")
    ...
    source = images[idx : idx + 1]
    # Very aggressive blur: kernel=7, sigma=2.0
    ...
    passed = source_pred == follow_up_pred
    print(f"\nSource image predicted as: {source_pred}")
    print(f"Aggressively blurred image predicted as: {follow_up_pred}")
    print(f"Status: {'PASS ✓' if passed else 'FAIL ✗'}")
    ...
    plot_images_side_by_side(
        ...
        follow_up[0],
        "Original",
        "Aggressive blur (k=7, σ=2.0)",
        source_pred,
        follow_up_logits,
        source_logits,
        follow_up_logits,
        "Challenge: Aggressive Blur",
        passed,
    )
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("\nShowing both PASSING and FAILING metamorphic relations\n")
    ...
    print("=" * 70)
    print("\nKey takeaway:")
    print("- MRs help detect when transformations break predictions")
    print("- Suitable seuils = sweet spot between true positives & false positives")
    print("- Guide model robustness improvements\n")
...
def demo_mr1_identity():
    ...
    source_pred = predict_top1(model, source, device).item()
    follow_up_pred = predict_top1(model, follow_up, device).item()

    print(f"\nSource image predicted as: {source_pred}")
    print(f"Follow-up (same) image predicted as: {follow_up_pred}")
    print(f"Match: {source_pred == follow_up_pred}")
...
def demo_mr2_double_flip():
    ...
    plot_images_side_by_side(
        ...
        source_pred,
        follow_up_pred,
        "MR2: Double Flip - Expected: predictions match (flip is reversible)",
    )
...
def demo_mr4_brightness():
    ...
    plot_images_side_by_side(
        ...
        source_pred,
        follow_up_pred,
        "MR4: Brightness - Expected: same prediction (or high match rate)",
    )
...
def demo_mr5_blur():
    ...
    plot_images_side_by_side(
        ...
        source_pred,
        follow_up_pred,
        "MR5: Blur - Expected: same prediction (or high match rate)",
    )


if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("METAMORPHIC TESTING VISUAL DEMO - MNIST")
    print("=" * 60)
